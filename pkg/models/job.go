...
type JobPost struct {
	...
	CreatedAt       time.Time              `json:"created_at" db:"created_at"`   // When job was added to OpenJobs
	UpdatedAt       time.Time              `json:"updated_at" db:"updated_at"`   // When job was last updated
}
